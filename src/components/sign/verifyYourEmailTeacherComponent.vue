    ...
    <div class="flex">
      ...
      <div class="mid">
        ...
        <div class="btns">
          ...
          <appButton @click="templateStore.sign = 6">Continuar</appButton>
        </div>
      </div>
    </div>
    <div class="bottom">
      <stepComponent first="Informações " second="Confirme seu E-Mail" third="Dados finais" step=2></stepComponent>
